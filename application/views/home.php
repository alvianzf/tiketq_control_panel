...
<head>
	...
	<title>PT. PELAYARAN SUKSES SINDO DAMAI</title>
...
<div class="container-fluid">
	<div class="row bg-img" id="header">
		<div class="section p-relative tp-30">
			<div class="col-md-7 font-white">
				<h1 class="font-bold font-xl">PT. PELAYARAN SUKSES SINDO DAMAI</h1>
				<p class="font-regular font-md">Mentoring kapalKapal</p>
			</div>
		</div>
	...
	<div class="row bg-img" id="rentyour">
		<div class="section font-white">
			<div class="col-md-9">
				<h2 class="font-lg font-bold">Jasa dan Layanan Pelayaran Container</h2><br>
				<p class="font-md font-medium">pelayanan kapal antar propinsi maupun pulau.</p><br>
				<a href="https://api.whatsapp.com/send?phone=6283172343533&amp;text=Assalamu%27alaikum, Saya ingin memesan tiket." class="btn btn-lg bg-purple font-bold">CONTACT US</a>
			</div>
		</div>
	</div>
